...
#ifndef MP_MSGS__SRV__DETAIL__EULER_TO_QUATERNION__FUNCTIONS_H_
#define MP_MSGS__SRV__DETAIL__EULER_TO_QUATERNION__FUNCTIONS_H_
 ...
 * calls
 * mp_msgs__srv__EulerToQuaternion_Request__init().
...
/**
 * It calls
 * mp_msgs__srv__EulerToQuaternion_Request__fini()
 ...
 * mp_msgs__srv__EulerToQuaternion_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mp_msgs__srv__EulerToQuaternion_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mp_msgs__srv__EulerToQuaternion_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mp_msgs
...
/**
 * It calls
 * mp_msgs__srv__EulerToQuaternion_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mp_msgs
...
/**
 * It allocates the memory for the array and calls
 * mp_msgs__srv__EulerToQuaternion_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mp_msgs
...
/**
 * It calls
 * mp_msgs__srv__EulerToQuaternion_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MP_MSGS__SRV__DETAIL__EULER_TO_QUATERNION__FUNCTIONS_H_
