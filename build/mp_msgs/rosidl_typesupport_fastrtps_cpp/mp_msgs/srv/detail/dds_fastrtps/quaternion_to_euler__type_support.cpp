...
#include "mp_msgs/srv/detail/quaternion_to_euler__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mp_msgs
cdr_serialize(
  const mp_msgs::srv::QuaternionToEuler_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mp_msgs::srv::QuaternionToEuler_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mp_msgs::srv::QuaternionToEuler_Request;
    is_plain =
      (
      offsetof(DataType, w) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const mp_msgs::srv::QuaternionToEuler_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mp_msgs::srv::QuaternionToEuler_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mp_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<mp_msgs::srv::QuaternionToEuler_Request>()
{
  return &mp_msgs::srv::typesupport_fastrtps_cpp::_QuaternionToEuler_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mp_msgs, srv, QuaternionToEuler_Request)() {
  return &mp_msgs::srv::typesupport_fastrtps_cpp::_QuaternionToEuler_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mp_msgs
cdr_serialize(
  const mp_msgs::srv::QuaternionToEuler_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: roll
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mp_msgs::srv::QuaternionToEuler_Response & ros_message)
{
  // Member: roll
  cdr >> ros_message.roll;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mp_msgs::srv::QuaternionToEuler_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mp_msgs::srv::QuaternionToEuler_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mp_msgs::srv::QuaternionToEuler_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mp_msgs::srv::typesupport_fastrtps_cpp::_QuaternionToEuler_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mp_msgs, srv, QuaternionToEuler_Response)() {
  return &mp_msgs::srv::typesupport_fastrtps_cpp::_QuaternionToEuler_Response__handle;
}
...
{
  return &mp_msgs::srv::typesupport_fastrtps_cpp::_QuaternionToEuler__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mp_msgs, srv, QuaternionToEuler)() {
  return &mp_msgs::srv::typesupport_fastrtps_cpp::_QuaternionToEuler__handle;
}
